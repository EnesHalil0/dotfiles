...
static const char *const autostart[] = {
  /*  */
  "xrandr", "--output", "HDMI-A-0", "--mode", "1920x1080", "-r", "75", "--primary", NULL,
  /* feh --bg-scale $HOME/dotfiles/wallpapers/kanagawa.jpg */
  "feh", "--bg-scale", "/home/ehd/dotfiles/wallpapers/kanagawa.jpg", NULL,
  "dunst", NULL,
	"nm-applet", NULL,
  "picom", "-b", NULL,
  "clipcatd", NULL,
...
static const Key keys[] = {
	...
	TAGKEYS(                        XK_8,                      7)
	TAGKEYS(                        XK_9,                      8)
	{ MODKEY|ControlMask|ShiftMask,             XK_q,      spawn,           {.v = (const char*[]){ "sysact", NULL } } },

  /* Clipboard */
  { MODKEY,                       XK_v,		   spawn,		       {.v = (const char*[]){ "clipcat-menu", NULL } } },

  /* Rofi */
  { MODKEY,                       XK_r,		   spawn,		       {.v = (const char*[]){ "rofi", "-show", "drun", "-show-icons", NULL } } },
